...
"https:www.sec.gov/Archives/edgar/data/1000180/0001000180-13-000009.txt"
...
In this case, the function to the left is paste(c(input, as.character(masterIndex$EDGAR_LINK[1])), collapse = ""). Its output is "https:www.sec.gov/Archives/edgar/data/1000180/0001000180-13-000009.txt".
...
The equivalent code is readLines("https:www.sec.gov/Archives/edgar/data/1000180/0001000180-13-000009.txt", encoding = "UTF-8").
